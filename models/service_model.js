...
var Service={
    ...
    updateService:function(item,callback){
        return db.query('update service_tbl set s_name=?,s_price=?,s_dur,s_disc=?,s_ben where s_id=?',[item.s_name,item.s_price,item.s_dur,item.s_disc,item.s_ben],callback);
    },
